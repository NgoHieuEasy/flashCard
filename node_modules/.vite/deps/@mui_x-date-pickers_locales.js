...
// node_modules/@mui/x-date-pickers/locales/bnBD.js
var views3 = {
  hours: "ঘণ্টা",
  minutes: "মিনিট",
  seconds: "সেকেন্ড",
...
var bnBDPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `নির্বাচন করুন ${views3[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "কোনও সময় নির্বাচন করা হয়নি" : `নির্বাচিত সময় ${formattedTime ?? utils.format(time, "fullTime")}}`}`,
...
var caESPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Selecciona ${views4[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Hora no seleccionada" : `L'hora seleccionada és ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var elGRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Επιλέξτε ${views5[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Δεν έχει επιλεγεί ώρα" : `Η επιλεγμένη ώρα είναι ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var esESPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Seleccione ${views6[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "No hay hora seleccionada" : `La hora seleccionada es ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var euPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Aukeratu ${views7[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Ez da ordurik aukertau" : `Aukeratutako ordua ${formattedTime ?? utils.format(time, "fullTime")} da`}`,
...
var fiFIPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Valitse ${views8[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Ei aikaa valittuna" : `Valittu aika on ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var frFRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Choix des ${views9[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Aucune heure choisie" : `L'heure choisie est ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var heILPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `בחירת ${views10[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "לא נבחרה שעה" : `השעה הנבחרת היא ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var itITPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Seleziona ${views11[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Nessun orario selezionato" : `L'ora selezionata è ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var koKRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `${views12[view]} 선택하세요. ${!formattedTime && (time === null || !utils.isValid(time)) ? "시간을 선택하지 않았습니다." : `현재 선택된 시간은 ${formattedTime ?? utils.format(time, "fullTime")}입니다.`}`,
...
var viVNPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Chọn ${views13[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Không có giờ được chọn" : `Giờ được chọn là ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var zhCNPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `选择 ${views14[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "未选择时间" : `已选择${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var zhHKPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `選擇 ${views15[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "未選擇時間" : `已選擇${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
// node_modules/@mui/x-date-pickers/locales/zhTW.js
var views16 = {
  hours: "小時",
  minutes: "分鐘",
  seconds: "秒",
...
var zhTWPickers = {
  ...
  dateRangePickerToolbarTitle: "選擇日期範圍",
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `選擇 ${views16[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "未選擇時間" : `已選擇${formattedTime ?? utils.format(time, "fullTime")}`}`,
  hoursClockNumberText: (hours) => `${hours}小時`,
  minutesClockNumberText: (minutes) => `${minutes}分鐘`,
  secondsClockNumberText: (seconds) => `${seconds}秒`,
  // Digital clock labels
